...
Download CSV to QLab from the [latest GitHub release](https://github.com/fross123/csv_to_qlab/releases/).
...
### 1. Confirm the initial message recieved
...
![Application Screenshot](/img/tutorial/app-screenshot.png)
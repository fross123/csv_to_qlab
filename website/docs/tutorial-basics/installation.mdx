...
:::info
CSV to QLab is FINALLY available as both a GUI application (Mac only) and a cross-platform command-line interface.
If you prefer a CLI, [follow these instructions](/docs/tutorial-basics/cli).
:::
...
See the [CLI Documentation](/docs/tutorial-basics/cli) for detailed usage instructions.
